...
public class JSONApp {
    ...
    public static JsonObject sessionResult() {
        ...
        JsonPair oopName = new JsonPair("course", new JsonString("OOP"));
        JsonPair oopMark = new JsonPair("mark", new JsonNumber(3));
        JsonPair oopPassed = new JsonPair("mark", new JsonNumber(3));

        JsonExamSample oopExam = new JsonExamSample("OOP", 3, true);
        JsonExamSample englishExam = new JsonExamSample("English", 5, true);
        JsonExamSample mathExam = new JsonExamSample("Math", 2, false);
